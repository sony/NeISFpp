...
class TrainerBase:
    ...
    Attributes:
        ...
        gain (float): a parameter for adjusting the overall image intensity
    ...
    def train(self):
        ...
        # prepare dataset.
        self.data = get_dataset(dataset_type=self.dataset_type, data_dir=self.data_dir, use_mask=self.use_mask, is_training=self.is_training)
        ...
        self.set_all_schedulers(decay_steps=self.max_epoch)
